...
def all_amenities():
    """ GET Method retrieve list of all Amenity objects """
    all_amenities = []
...
def retrieve_amenity(amenity_id):
    """ GET Method to retrieve a particular Amenity """
...
def delete_amenity(amenity_id):
    """ DELETE Method delete an Amenity """
    amenity = storage.get('Amenity', amenity_id)
    if amenity:
